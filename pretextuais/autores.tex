...
\begin{authorcard}
\centering
{\small \bfseries Ronaldo Camilo dos Santos}
...
Universidade Estadual de Campinas. Tem experiência na área de telecomunicações, atuando, principalmente, nos seguintes temas: radiocomunicação, ciência de dados, inteligência artificial e desenvolvimento de software.
\end{authorcard}
\end{minipage}
