...
\usepackage[most]{tcolorbox}\usepackage{titlesec}    % Para customizar títulos
...
\lhead{\color{verdeuni} \textbf{Prof. Me. Sergio Souza Novak, Prof. Leandro, Prof. Ronaldo}} 
...
% =======================
\usepackage[
    style=abnt, % Use ABNT style or authoryear for full references
    backend=biber
]{biblatex}

% Comando para gerar a citação bibliográfica completa na nota de rodapé
\let\cite\footfullcite
\let\autocite\footfullcite
