...
\newcommand{\authorpage}{
  ...
  \begin{center}
    ...
    \begin{minipage}{0.85\textwidth}
      ...
      do Cerrado e também na fruticultura e psicultura. Atualmente, Sergio é Mestre em Ciências Agrárias e professor na Universidade de Rio Verde (UNIRV), docente responsável pela disciplina de Banco de Dados no curso de Engenharia de Software.
    \end{minipage}
  \end{center}
  \newpage
}
...
\setlength{\fboxrule}{1pt}
      \fbox{\includegraphics[width= 10cm ]{capa.jpg}}
